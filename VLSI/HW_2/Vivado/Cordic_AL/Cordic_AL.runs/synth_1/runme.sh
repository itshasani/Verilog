...
HD_PWD='E:/VLSI/HW2/Vivado/Cordic_AL/Cordic_AL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cordic_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cordic_top.tcl
