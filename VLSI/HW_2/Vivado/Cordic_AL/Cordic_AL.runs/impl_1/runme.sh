...
HD_PWD='E:/VLSI/HW2/Vivado/Cordic_AL/Cordic_AL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cordic_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cordic_top.tcl -notrace
